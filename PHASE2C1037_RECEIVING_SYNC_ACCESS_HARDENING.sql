-- ============================================================
-- PharmFlow Phase 2C.10.3.7
-- Receiving Ledger Access Hardening
--
-- SAFE / NON-DESTRUCTIVE MIGRATION
-- - Does NOT delete active Orders, receiving transactions, history,
--   Returns Archive, Global GTIN Master, users, or sessions.
-- - Reuses the self-contained membership check introduced by 2C.10.3.6.
-- - Replaces only the receiving-ledger RPC definitions.
-- ============================================================

-- Ensure the self-contained membership helper exists even if this migration
-- is applied independently after the original 2C.10.3.6 deployment.
