...
function isPharmFlowIdleSleeping(){
    return !!(window.PharmFlowIdleSleep && window.PharmFlowIdleSleep.sleeping===true);
}
...
function initializeSupabaseCloud(){
    ...
    window.addEventListener("online", function(){
        ...
        if(isPharmFlowIdleSleeping()) return;
